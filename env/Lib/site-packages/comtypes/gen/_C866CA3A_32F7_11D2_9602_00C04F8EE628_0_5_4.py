...
__all__ = [
    'DISPID_SRCERecognizerStateChange', 'SpeechBookmarkOptions',
    'SPSNotOverriden', 'DISPID_SRCEPhraseStart',
    'DISPID_SPARecoResult', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SVAlertBoundary', 'DISPID_SRCEStartStream', 'SPRULESTATE',
    'SVP_15', 'SpeechAudioFormatType', 'DISPID_SPISaveToMemory',
    'ISpPhraseAlt', 'DISPID_SPPValue', 'SVSFPersistXML',
    'SPSHORTCUTTYPE', 'SPEI_END_INPUT_STREAM', 'DISPID_SGRsDynamic',
    'DISPID_SMSSetData', 'DISPID_SRGSetTextSelection',
    'DISPID_SpeechLexiconWords', 'SAFT16kHz8BitStereo',
    '_SPAUDIOSTATE', 'SPLO_STATIC', 'SPSHT_OTHER',
    'eLEXTYPE_PRIVATE8', 'DISPID_SAVolume', 'DISPID_SVSRunningState',
    'DISPID_SLWWord', 'ISpeechObjectToken', 'SpSharedRecoContext',
    'DISPID_SpeechPhraseProperties', 'DISPID_SRCVoice', 'SRSInactive',
    'eLEXTYPE_PRIVATE5', 'SLODynamic', 'ISpeechPhraseReplacements',
    'SGRSTTRule', 'DISPID_SPRulesItem', 'SVP_9', 'ISpMMSysAudio',
    'SBONone', 'DISPID_SRGetRecognizers', 'ISpeechPhraseElements',
    'SREPhraseStart', 'SAFT22kHz16BitStereo', 'WAVEFORMATEX',
    'SPRS_ACTIVE', 'DISPID_SMSADeviceId',
    'SpeechPropertyLowConfidenceThreshold', 'SECFIgnoreCase',
    'SVP_17', 'SDA_No_Trailing_Space', 'eLEXTYPE_MORPHOLOGY',
    'SAFT16kHz16BitStereo', 'DISPID_SMSGetData',
    'SAFT22kHz8BitStereo', 'eLEXTYPE_RESERVED8', 'DISPID_SPRuleId',
    'SRADefaultToActive', 'ISpEventSink', 'SPINTERFERENCE_TOOSLOW',
    'ISpeechObjectTokens', 'SSSPTRelativeToEnd', 'DISPID_SOTCategory',
    'SAFTDefault', 'SITooSlow', 'eLEXTYPE_PRIVATE20',
    'DISPID_SABIEventBias', 'DISPID_SRAudioInput', 'SPPROPERTYINFO',
    'SPWF_SRENGINE', 'SPPHRASE', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SpNotifyTranslator', 'DISPID_SRCEFalseRecognition',
    'DISPID_SASNonBlockingIO', 'DISPID_SVSLastBookmarkId',
    'SPBOOKMARKOPTIONS', 'SpFileStream', 'SLOStatic',
    'DISPID_SVSLastStreamNumberQueued', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SLPLangId', 'DISPID_SpeechPhoneConverter', 'SVPOver',
    'DISPID_SASFreeBufferSpace', 'SSFMOpenForRead', 'SLTUser',
    'SpeechStreamFileMode', 'ISpRecoGrammar', 'SPEI_SR_RETAINEDAUDIO',
    'SAFT24kHz8BitStereo', 'SAFT48kHz8BitStereo',
    'DISPID_SVSInputWordLength', 'DISPID_SRStatus',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SDKSetBinaryValue',
    'SAFT22kHz8BitMono', 'SGDSActiveUserDelimited', 'SPFILEMODE',
    'SpCustomStream', 'SP_VISEME_15', 'DISPID_SRGSetWordSequenceData',
    'SPBO_AHEAD', 'SREAudioLevel', 'ISequentialStream', 'SLTApp',
    'SSFMOpenReadWrite', 'SASRun',
    'DISPID_SRCAudioInInterferenceStatus', 'SDA_Two_Trailing_Spaces',
    'SPEI_MIN_TTS', 'SAFT44kHz16BitStereo', 'SRESoundEnd',
    'DISPID_SRGCmdLoadFromObject', 'eLEXTYPE_PRIVATE3', 'SASClosed',
    'eLEXTYPE_VENDORLEXICON', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SAFTNoAssignedFormat', 'SpeechUserTraining', 'SPWAVEFORMATTYPE',
    'DISPID_SRGCmdLoadFromFile', 'SAFTCCITT_ALaw_22kHzMono',
    'DISPID_SOTCDefault', 'SP_VISEME_2', 'SPAS_RUN',
    'SpeechTokenContext', 'DISPID_SPRules_NewEnum', 'SVP_21',
    'SAFTCCITT_uLaw_22kHzStereo', 'SRSEDone', 'ISpResourceManager',
    'SpeechGrammarWordType', 'DISPID_SRAudioInputStream',
    'SGRSTTEpsilon', 'SVEVoiceChange', 'SpeechAudioFormatGUIDWave',
    'SSTTDictation', 'SAFT32kHz8BitMono', 'SPEI_TTS_PRIVATE',
    'DISPID_SLWType', 'SPPS_Interjection', 'ISpeechLexiconWords',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SPIEnginePrivateData', 'SPEI_PROPERTY_NUM_CHANGE',
    'SPRST_ACTIVE_ALWAYS', 'STSF_CommonAppData',
    'DISPID_SpeechPhraseRules', 'SASPause', 'SVSFParseSsml',
    'SPSMF_SAPI_PROPERTIES', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SPWORDPRONUNCIATIONLIST', 'SVP_4', 'SPSUnknown',
    'SAFTExtendedAudioFormat', 'SPSInterjection', 'SPPS_RESERVED4',
    'eLEXTYPE_PRIVATE10', 'DISPID_SPEAudioTimeOffset',
    'SWPUnknownWordUnpronounceable', 'SREPropertyStringChange',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SVSInputWordPosition',
    'ISpeechVoiceStatus', 'SPEI_ADAPTATION', 'SpVoice', 'SPSNoun',
    'DISPID_SRSClsidEngine', 'DISPID_SRGetPropertyNumber',
    'DISPID_SpeechGrammarRuleStateTransition', 'DISPID_SPIProperties',
    'SPGRAMMARWORDTYPE', 'DISPID_SRSetPropertyString',
    'DISPID_SRCEAdaptation', 'SpMemoryStream', 'eLEXTYPE_PRIVATE12',
    'SECLowConfidence', 'DISPID_SVSpeakStream', 'ISpRecoCategory',
    'SPSHORTCUTPAIR', 'SPAUDIOSTATUS', 'SPAS_STOP',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SVEEnginePrivate',
    'DISPID_SAFGuid', 'ISpeechRecoGrammar', 'SP_VISEME_8',
    'SPEI_INTERFERENCE', 'SPDKL_LocalMachine',
    'DISPID_SRCERecognition', 'SAFT24kHz16BitMono', 'ISpRecognizer2',
    'ISpeechTextSelectionInformation', 'SREStateChange',
    'DISPID_SRGCmdSetRuleIdState', 'DISPID_SpeechAudioStatus',
    'SPEI_TTS_BOOKMARK', 'SRTSMLTimeout', 'SPFM_CREATE_ALWAYS',
    '__MIDL_IWinTypes_0009', 'DISPID_SRRGetXMLResult',
    'Speech_Max_Pron_Length', 'DISPID_SPRDisplayAttributes',
    'DISPID_SPRsItem', 'SPEI_SR_PRIVATE', 'DISPID_SPAsItem',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SPEI_RESERVED5',
    'DISPID_SpeechCustomStream', 'DISPID_SDKEnumKeys',
    'DISPID_SOTDisplayUI', 'ISpPhoneticAlphabetConverter',
    'SAFTADPCM_11kHzStereo', 'DISPID_SLPSymbolic',
    'DISPID_SGRAddState', 'ISpeechGrammarRule',
    'DISPID_SOTGetDescription', 'DISPID_SpeechMMSysAudio',
    'DISPID_SVRate', 'SINone', 'SAFTADPCM_22kHzStereo',
    'DISPID_SVESentenceBoundary', 'ISpProperties',
    'DISPID_SRRPhraseInfo', 'DISPID_SGRSTPropertyValue',
    'ISpeechAudio', 'eLEXTYPE_PRIVATE14', 'eLEXTYPE_PRIVATE19',
    'DISPID_SPPChildren', 'SAFTADPCM_8kHzStereo', 'SECFIgnoreWidth',
    'SP_VISEME_3', 'SPCONTEXTSTATE',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SpeechDataKeyLocation',
    'SPCT_SUB_COMMAND', 'DISPID_SWFEAvgBytesPerSec', 'DISPID_SGRsAdd',
    'ISpeechRecoResultDispatch', 'SpeechTokenKeyUI',
    'SpPhoneConverter', 'ISpRecoContext', 'SVPAlert', 'SVEBookmark',
    'SVEPhoneme', 'SPSERIALIZEDRESULT', 'SVSFlagsAsync',
    'SAFT32kHz16BitMono', 'DISPID_SVVolume', 'SP_VISEME_4',
    'SpCompressedLexicon', 'ISpeechGrammarRuleStateTransitions',
    'SPFM_NUM_MODES', 'SAFT8kHz16BitStereo', 'DISPID_SGRSTType',
    'SAFT8kHz16BitMono', 'DISPID_SBSSeek',
    'DISPID_SpeechPhraseElement', 'DISPID_SPIReplacements',
    'DISPID_SDKEnumValues', 'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SRCPause', 'DISPID_SPIAudioSizeTime', 'Library',
    'SWPUnknownWordPronounceable', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SVEViseme', 'DISPID_SRCCreateGrammar', 'SVSFUnusedFlags',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SOTId', 'ISpVoice',
    'eLEXTYPE_PRIVATE7', 'DISPID_SRGCommit', 'SAFTGSM610_22kHzMono',
    'DISPID_SRCState', 'DISPID_SPRuleFirstElement',
    'DISPID_SRCBookmark', 'DISPID_SPEDisplayAttributes',
    'DISPID_SPRuleParent', 'SpeechPropertyHighConfidenceThreshold',
    'ISpeechRecoResultTimes', 'ISpPhrase', 'DISPID_SVSPhonemeId',
    'DISPID_SRCEEnginePrivate', 'SPAUDIOOPTIONS',
    'SpeechCategoryRecoProfiles', 'SRAImport',
    'Speech_StreamPos_Asap', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SpeechXMLRecoResult', 'SPPS_Modifier',
    'SECFIgnoreKanaType', 'DISPID_SVEWord',
    'DISPID_SRGCmdLoadFromMemory', 'SINoSignal',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SVResume',
    'SVEAllEvents', 'SAFTADPCM_44kHzStereo', 'eLEXTYPE_USER',
    'ISpeechAudioBufferInfo', 'SDA_One_Trailing_Space',
    'SpeechCategoryAppLexicons', 'eLEXTYPE_RESERVED7', 'ISpDataKey',
    'STCInprocServer', 'DISPID_SPPParent', 'SPEI_HYPOTHESIS',
    'DISPID_SPPsItem', 'SpeechCategoryAudioOut',
    'DISPID_SRCSetAdaptationData', 'DISPID_SGRId',
    'SpStreamFormatConverter', 'DISPID_SVStatus',
    'eLEXTYPE_RESERVED9', 'DISPID_SPRs_NewEnum',
    'SpeechGrammarTagDictation', 'SpeechPartOfSpeech',
    'SDTAlternates', 'DISPID_SRGState', 'SVF_Stressed',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SPIElements', 'DISPID_SpeechAudioBufferInfo',
    'SPWORDPRONOUNCEABLE', 'SGDSActive', 'SAFT12kHz16BitMono',
    'SPBO_NONE', 'SpeechStreamSeekPositionType',
    'SpeechVisemeFeature', 'SpeechAddRemoveWord',
    'eLEXTYPE_PRIVATE13', 'DISPID_SOTRemoveStorageFileName',
    'Speech_Default_Weight', 'SP_VISEME_12', 'SpSharedRecognizer',
    'SpResourceManager', 'SAFT11kHz16BitMono',
    'DISPID_SPRuleConfidence', 'ISpeechPhraseRules',
    'DISPID_SRCEInterference', 'ISpeechRecoContext', 'SpMMAudioEnum',
    'SVSFParseAutodetect', 'SECNormalConfidence',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SpeechDataKey',
    'DISPID_SOTs_NewEnum', 'SVF_None', 'DISPID_SRCRetainedAudio',
    'SECHighConfidence', 'SVSFNLPSpeakPunc',
    'SpeechTokenIdUserLexicon', 'SITooQuiet', 'SPPS_RESERVED2',
    'DISPID_SRRTStreamTime', 'SPAO_RETAIN_AUDIO', 'DISPID_SOTDataKey',
    'UINT_PTR', 'SPBO_PAUSE', 'DISPID_SpeechGrammarRule',
    'DISPID_SPPs_NewEnum', 'SVEViseme', 'ISpeechLexiconWord',
    'DISPID_SGRSTs_NewEnum', 'SPPS_RESERVED1',
    'DISPID_SVEStreamStart', 'DISPID_SPIEngineId',
    'DISPID_SpeechPhraseProperty', 'DISPID_SVSyncronousSpeakTimeout',
    'SpeechDisplayAttributes', 'DISPID_SPRulesCount',
    'DISPID_SLPPhoneIds', 'DISPID_SPRuleEngineConfidence',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SRRTOffsetFromStart',
    'SRAInterpreter', 'SPRS_ACTIVE_USER_DELIMITED',
    'SPRECORESULTTIMES', 'SPFM_OPEN_READONLY', 'STSF_FlagCreate',
    'DISPID_SOTGetStorageFileName', 'SRSInactiveWithPurge',
    'ISpeechRecoResult', 'SPCT_SUB_DICTATION',
    'DISPID_SOTIsUISupported', 'DISPID_SOTSetId', 'SGRSTTTextBuffer',
    'ISpeechPhraseInfo', 'SPAR_Medium',
    'DISPID_SPERetainedStreamOffset', 'SPDKL_CurrentUser',
    ...
    'SpeechVoiceEvents', 'SVP_0', 'eLEXTYPE_PRIVATE6',
    'DISPID_SGRSAddWordTransition', 'SP_VISEME_11', 'SPEVENT',
    'SFTInput', 'DISPID_SWFEBlockAlign', 'DISPID_SPEAudioSizeTime',
    'DISPID_SPEAudioStreamOffset', 'ISpeechResourceLoader',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SVSFVoiceMask',
    'eLEXTYPE_PRIVATE11', 'SPEI_MIN_SR', 'SRERecognition',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SBSFormat',
    'DISPID_SVWaitUntilDone', 'DISPID_SLWLangId',
    'SAFT12kHz16BitStereo', 'SPAR_High', '_RemotableHandle',
    'SP_VISEME_0', 'DISPID_SRGCmdLoadFromResource', 'SVP_1', 'SVP_14',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SDTRule',
    'DISPID_SGRInitialState', 'SPRS_INACTIVE', 'SAFT48kHz16BitMono',
    'DISPID_SWFEChannels', 'SPRECOSTATE', 'DISPID_SPEs_NewEnum',
    'DISPID_SWFEBitsPerSample', 'SGPronounciation',
    'DISPID_SRIsShared', 'ISpNotifySource',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SMSALineId',
    'SGDSInactive', 'SpeechVoiceSpeakFlags',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SPCIdToPhone',
    'SREStreamEnd', 'SPVPRI_ALERT', 'DISPID_SLWPronunciations',
    'DISPID_SpeechBaseStream', 'DISPID_SGRClear', 'SPVPRI_OVER',
    'ISpNotifyTranslator', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SABIMinNotification', 'DISPID_SPILanguageId',
    'STCLocalServer', 'SPRECOGNIZERSTATUS', 'ISpeechAudioStatus',
    'DISPID_SRCERequestUI', 'SpeechRuleState', 'SPDKL_CurrentConfig',
    'ISpeechObjectTokenCategory', 'DISPID_SPAPhraseInfo',
    'eWORDTYPE_ADDED', 'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SFSOpen',
    'SGRSTTWord', 'SVPNormal', 'STCAll', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SVSInputSentencePosition', 'DISPID_SOTCSetId',
    'SpeechEmulationCompareFlags', 'SPPARTOFSPEECH',
    'DISPID_SRCEventInterests', 'SDTPronunciation',
    'eLEXTYPE_PRIVATE16', 'DISPID_SRGDictationLoad',
    'DISPID_SpeechRecoResultTimes', 'SPPS_SuppressWord',
    'SVSFDefault', 'SpUnCompressedLexicon', 'DISPID_SPPName',
    'SpeechRunState', 'ISpeechRecognizerStatus',
    ...
    'SAFT44kHz8BitStereo', 'SPSHT_Unknown', 'DISPID_SRRAlternates',
    'ISpeechPhraseInfoBuilder', 'SVSFParseMask',
    'DISPID_SGRSAddRuleTransition', 'ISpPhoneConverter',
    'SPSEMANTICFORMAT', 'SPSVerb', 'SITooFast', 'SPLO_DYNAMIC',
    'DISPID_SLGetWords', 'SRCS_Disabled', 'SPEI_MAX_TTS',
    'ISpeechGrammarRules', 'DISPID_SRGetFormat', 'DISPID_SASState',
    'SPVISEMES', 'DISPID_SpeechLexiconPronunciation',
    'SPEI_TTS_AUDIO_LEVEL', 'SpeechWordType',
    'SpeechRegistryUserRoot', 'SPAO_NONE', 'eLEXTYPE_APP',
    'DISPID_SVSpeak', 'DISPID_SDKSetStringValue', 'DISPID_SOTCId',
    'ISpeechPhraseProperty', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SRRTimes', 'DISPID_SPRuleNumberOfElements',
    'SRERequestUI', 'SPPS_NotOverriden', 'DISPID_SLPsCount',
    'SDTReplacement', 'DISPID_SPPEngineConfidence',
    'SpeechVoiceSkipTypeSentence', 'SAFT22kHz16BitMono',
    'SPBINARYGRAMMAR', 'DISPID_SPCLangId', 'SVP_10', 'SPINTERFERENCE',
    'DISPID_SPEsCount', 'SREPropertyNumChange',
    'DISPID_SPEDisplayText', 'DISPID_SGRSTransitions',
    'SECFNoSpecialChars', 'DISPID_SRCESoundStart',
    'DISPID_SRGDictationUnload', 'DISPID_SVGetVoices', 'SASStop',
    'SGRSTTDictation', 'DISPID_SVIsUISupported',
    'SpeechTokenKeyFiles', 'SPPHRASEELEMENT',
    'SpeechWordPronounceable', 'SpeechAudioFormatGUIDText',
    'SAFTADPCM_11kHzMono', 'DISPID_SWFEFormatTag', 'DISPID_SPRsCount',
    'SPEI_SOUND_END', 'SPAR_Unknown', 'SVP_16',
    'DISPID_SpeechPhraseInfo', 'SPTEXTSELECTIONINFO',
    'DISPID_SRGReset', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SVEBookmark', 'SpAudioFormat', 'SPDATAKEYLOCATION',
    'SDKLCurrentUser', 'SPWT_PRONUNCIATION', 'SPSFunction',
    'ISpeechCustomStream', 'ISpRecoResult', 'ISpSerializeState',
    ...
    'SPSSuppressWord', 'SpeechRecoContextState', 'SVP_18',
    'SAFT11kHz8BitStereo', 'SVSFIsFilename', 'SP_VISEME_6',
    'SpNullPhoneConverter', 'SpeechDictationTopicSpelling',
    'SWPKnownWordPronounceable', 'SP_VISEME_21', 'DISPID_SPEsItem',
    'SPSHORTCUTPAIRLIST', 'SPRULE',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SpeechWaveFormatEx', 'ISpGrammarBuilder',
    'SPEI_END_SR_STREAM', 'SREInterference', 'SAFT32kHz8BitStereo',
    'ISpNotifySink', 'DISPID_SpeechPhraseBuilder', 'DISPID_SPPId',
    'DISPID_SPIAudioSizeBytes', 'SVP_5', 'SP_VISEME_20',
    'DISPID_SRRSpeakAudio', 'SVEWordBoundary', 'SVF_Emphasis',
    'SP_VISEME_19', 'SRAExport', 'SVSFIsXML', 'ISpeechMemoryStream',
    'DISPID_SBSRead', 'DISPID_SpeechGrammarRuleState',
    'eLEXTYPE_RESERVED6', 'DISPIDSPTSI_SelectionOffset',
    'SRATopLevel', 'SPRECOCONTEXTSTATUS', 'SGLexical',
    'DISPID_SOTRemove', 'ISpeechPhraseRule', 'SPINTERFERENCE_TOOFAST',
    'SpPhraseInfoBuilder', 'eLEXTYPE_PRIVATE1', 'SVEAudioLevel',
    'SAFT8kHz8BitMono', 'DISPID_SRProfile', 'SpeechTokenValueCLSID',
    'SPSHT_NotOverriden', 'DISPID_SpeechObjectTokens',
    'SpeechRecognizerState', 'DISPID_SVDisplayUI', 'SPWORD',
    'SGRSTTWildcard', 'SVP_12', 'DISPID_SpeechAudio',
    'DISPID_SOTCreateInstance', 'DISPID_SVPause',
    'SpeechRetainedAudioOptions', 'DISPID_SGRSTText',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SDKSetLongValue', 'ISpAudio',
    'DISPID_SPRuleChildren', 'DISPID_SLPs_NewEnum', 'SRCS_Enabled',
    'eLEXTYPE_PRIVATE9', 'SSTTWildcard', 'SpTextSelectionInformation',
    'DISPID_SGRsFindRule', 'SPWORDPRONUNCIATION',
    'SGLexicalNoSpecialChars', 'ISpeechPhraseProperties',
    'DISPID_SPPsCount', 'SSFMCreateForWrite',
    'DISPID_SDKGetStringValue', 'SPWF_INPUT', 'DISPID_SRCEEndStream',
    'DISPID_SPEEngineConfidence', 'eLEXTYPE_PRIVATE18', 'SFTSREngine',
    'SDTLexicalForm', 'SAFT11kHz16BitStereo',
    'SAFTCCITT_ALaw_11kHzStereo', 'SAFTCCITT_ALaw_44kHzStereo',
    'ISpStreamFormat', 'DISPID_SLWsItem', 'DISPID_SLPPartOfSpeech',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SVSLastResult',
    'DISPID_SGRsCount', 'STCInprocHandler',
    'SAFTCCITT_uLaw_44kHzMono', 'SPEI_SR_AUDIO_LEVEL', 'SAFTText',
    'DISPID_SVGetAudioOutputs', 'IEnumString',
    'SpeechEngineProperties', 'DISPID_SRRAudioFormat',
    'SAFTADPCM_22kHzMono', 'SPPS_Noncontent', 'DISPID_SRDisplayUI',
    'SPGRAMMARSTATE', 'SVP_6', 'SVP_11',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SLPsItem',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SPPConfidence',
    'STSF_LocalAppData', 'DISPID_SRCEHypothesis',
    'SAFT48kHz16BitStereo', 'DISPID_SpeechVoiceStatus',
    'SPADAPTATIONRELEVANCE', 'SSSPTRelativeToCurrentPosition',
    'SDKLCurrentConfig', 'SRTExtendableParse', 'SPPHRASEREPLACEMENT',
    'SpeechVisemeType', 'DISPID_SVGetProfiles', 'ISpeechDataKey',
    'eLEXTYPE_PRIVATE4', 'SpWaveFormatEx', 'SPRST_ACTIVE',
    'STSF_AppData', 'DISPID_SGRSTsItem', 'SPEI_VOICE_CHANGE',
    'DISPID_SGRSTPropertyName', 'DISPID_SVEAudioLevel',
    'SPEI_FALSE_RECOGNITION', 'SPPS_RESERVED3', 'SREHypothesis',
    'SpInProcRecoContext', 'DISPID_SFSClose', 'ISpeechAudioFormat',
    'DISPID_SASCurrentSeekPosition',
    'DISPID_SRCEPropertyNumberChange', 'SGSExclusive',
    'DISPID_SWFEExtraData', 'DISPID_SVVoice',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SRIsUISupported',
    'DISPID_SDKGetlongValue', 'SECFEmulateResult', 'SPAS_CLOSED',
    'DISPID_SOTGetAttribute', 'DISPIDSPTSI', 'SPPS_LMA',
    'SpeechRecognitionType', 'DISPID_SRSCurrentStreamNumber',
    'SP_VISEME_17', 'SGDSActiveWithAutoPause', 'DISPID_SLPType',
    'DISPID_SGRSAddSpecialTransition',
    'DISPID_SRSNumberOfActiveRules', 'SP_VISEME_16',
    'DISPID_SOTCGetDataKey', 'DISPID_SPIAudioStreamPosition',
    'SpLexicon', 'SAFTNonStandardFormat', 'SPEI_PHRASE_START',
    ...
    'SVSFPurgeBeforeSpeak', 'SP_VISEME_9', 'LONG_PTR',
    'DISPID_SPIGrammarId', 'DISPID_SLRemovePronunciationByPhoneIds',
    'SDTAll', 'ISpObjectTokenCategory', 'DISPID_SVSpeakCompleteEvent',
    'SpeechSpecialTransitionType', 'SVP_20',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SpeechFormatType',
    'DISPID_SRCreateRecoContext', 'SRARoot', 'SDTProperty',
    'SPRST_NUM_STATES', 'SPDKL_DefaultLocation', 'SREAllEvents',
    'DISPID_SRState', 'SPEI_RESERVED6', 'SpStream',
    'Speech_StreamPos_RealTime', 'SAFTCCITT_uLaw_44kHzStereo',
    'SpeechAudioState', 'DISPID_SGRsCommitAndSave',
    'SPEI_START_SR_STREAM', 'SPCS_DISABLED', 'ISpObjectToken',
    'SpeechPropertyComplexResponseSpeed', 'Speech_Max_Word_Length',
    'SP_VISEME_13', 'SP_VISEME_14', 'ISpEventSource', 'typelib_path',
    'SPGS_EXCLUSIVE', 'SPVOICESTATUS', 'SINoise',
    'DISPID_SRCRequestedUIType', 'SpeechVoiceCategoryTTSRate',
    'SPSModifier', 'SRERecoOtherContext', 'SpeechRecoEvents',
    'DISPID_SLWs_NewEnum', 'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SRRAudio', 'DISPID_SpeechRecoContextEvents',
    'ISpeechPhoneConverter', 'SAFT16kHz16BitMono',
    'DISPID_SPPNumberOfElements', 'DISPID_SGRAddResource',
    'SpMMAudioOut', 'eLEXTYPE_PRIVATE15', 'DISPID_SBSWrite',
    'DISPID_SLRemovePronunciation', 'DISPID_SpeechRecoContext',
    'DISPID_SRRTLength', 'DISPID_SPAsCount', 'SPCT_SLEEP',
    'DISPID_SPACommit', 'SPXRO_SML', 'ISpeechMMSysAudio',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SRGId',
    'SAFTCCITT_ALaw_11kHzMono', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SDKDeleteKey', 'ISpPhoneticAlphabetSelection',
    'DISPID_SPAs_NewEnum', 'DISPID_SPRFirstElement', 'SPCS_ENABLED',
    ...
    'DISPID_SpeechAudioFormat', 'DISPID_SABIBufferSize',
    'DISPID_SOTCEnumerateTokens', 'SpeechPropertyResourceUsage',
    'SPSTREAMFORMATTYPE', 'ISpObjectWithToken',
    'SpeechRuleAttributes', 'DISPIDSPRG',
    'DISPID_SRSetPropertyNumber', 'SPPS_Function',
    'DISPID_SPPFirstElement', 'DISPID_SDKOpenKey',
    'SpObjectTokenCategory', 'SGSDisabled', 'SpeechAudioVolume',
    'DISPID_SRSAudioStatus', 'SPEVENTENUM', 'ISpeechLexicon',
    'DISPID_SpeechRecoResult2', 'DISPID_SRCEAudioLevel',
    'SpeechGrammarTagWildcard', 'SDTAudio',
    'DISPID_SDKGetBinaryValue', 'SVEStartInputStream',
    'SRSActiveAlways', 'DISPID_SRCVoicePurgeEvent', 'SITooLoud',
    'SpeechLoadOption', 'SRAONone', 'DISPID_SMSAMMHandle',
    'DISPID_SPIGetText', 'SPAUDIOSTATE',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SpeechObjectToken', 'SVP_7', 'DISPID_SOTsCount',
    'SAFTGSM610_8kHzMono', 'SpeechGrammarRuleStateTransitionType',
    'DISPID_SPEAudioSizeBytes', 'SPPS_Unknown', 'SPWORDLIST',
    'DISPID_SLGetGenerationChange', 'DISPID_SVPriority',
    'DISPID_SLGetPronunciations', 'ISpRecoContext2',
    'SVEEndInputStream', 'SpeechPropertyResponseSpeed',
    'DISPID_SPIRule', 'DISPID_SRCEBookmark', 'ISpStream', 'SVP_13',
    'SPINTERFERENCE_TOOLOUD', 'SAFTADPCM_44kHzMono',
    'DISPID_SPERequiredConfidence', 'ISpeechXMLRecoResult',
    'DISPID_SRRTTickCount', 'SREAdaptation',
    'DISPID_SRSSupportedLanguages', 'DISPID_SRGCmdSetRuleState',
    'ISpeechPhraseAlternate', 'DISPID_SLWsCount',
    'DISPID_SDKCreateKey', '_ISpeechRecoContextEvents', 'SPEI_MAX_SR',
    'DISPID_SPRNumberOfElements', 'SPWORDTYPE',
    'SAFT32kHz16BitStereo', 'ISpeechPhraseAlternates',
    'SRSEIsSpeaking', 'SWTDeleted', 'ISpRecognizer3',
    'SPCT_DICTATION', 'SREBookmark', 'DISPID_SRCESoundEnd',
    'DISPID_SVAudioOutput', 'ISpLexicon', 'SPPHRASERULE',
    'eLEXTYPE_PRIVATE2', 'DISPID_SGRsItem',
    'SDA_Consume_Leading_Spaces', 'DISPID_SGRSTWeight',
    'DISPID_SVSLastBookmark', 'eLEXTYPE_PRIVATE17',
    'IEnumSpObjectTokens', 'DISPID_SpeechLexicon',
    'SpeechCategoryVoices', 'SAFT8kHz8BitStereo',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SPELexicalForm',
    'SSTTTextBuffer', 'SAFT44kHz16BitMono',
    'DISPID_SpeechLexiconProns', 'DISPIDSPTSI_ActiveLength',
    'SVSFNLPMask', 'SpPhoneticAlphabetConverter',
    'SAFT24kHz16BitStereo', 'DISPID_SRGRules',
    'DISPID_SDKDeleteValue', 'DISPID_SpeechMemoryStream',
    'DISPID_SGRSTsCount', 'ISpeechFileStream', 'SREStreamStart',
    'SPRST_INACTIVE', 'SPFM_OPEN_READWRITE',
    'SAFTTrueSpeech_8kHz1BitMono', 'SPVPRI_NORMAL', 'SPAR_Low',
    'SRSActive', 'DISPID_SRRecognizer', 'DISPID_SpeechFileStream',
    'SpeechCategoryPhoneConverters', 'SpeechDiscardType',
    'SPPHRASEPROPERTY', 'SPLEXICONTYPE', 'DISPID_SpeechVoiceEvent',
    'SWTAdded', 'DISPID_SRCRetainedAudioFormat', 'SAFT16kHz8BitMono',
    'SpeechGrammarState', 'ISpXMLRecoResult', 'ISpeechWaveFormatEx',
    'SVESentenceBoundary', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SPEPronunciation', 'SPSLMA', 'SPLOADOPTIONS',
    'SpShortcut', 'DISPID_SGRAttributes', 'SPEI_PHONEME',
    'SPGS_ENABLED', 'ISpeechRecognizer', 'SP_VISEME_1',
    'SPEI_SENTENCE_BOUNDARY', 'SPEVENTSOURCEINFO', 'SPEI_RESERVED1',
    'DISPID_SGRSRule', 'ISpeechPhraseReplacement',
    'SDKLDefaultLocation', 'ISpeechBaseStream', 'SPEI_SOUND_START',
    'SpeechLexiconType', 'DISPID_SVEventInterests', 'SVSFIsNotXML',
    'DISPID_SpeechRecognizer', 'SGDisplay', 'SSFMCreate',
    'SPFM_CREATE', 'DISPID_SAEventHandle',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SP_VISEME_18',
    'STCRemoteServer', 'DISPID_SAStatus', 'SPWT_LEXICAL',
    'SAFT48kHz8BitMono', 'DISPID_SPRuleName',
    'SAFTCCITT_uLaw_11kHzMono', 'SpeechCategoryAudioIn',
    'SpeechAudioProperties', 'DISPID_SGRSTNextState',
    'DISPID_SWFESamplesPerSec', 'SP_VISEME_5', 'SAFTADPCM_8kHzMono',
    'SDKLLocalMachine', 'DISPID_SLAddPronunciation',
    'DISPID_SABufferInfo', 'DISPID_SABufferNotifySize',
    'DISPID_SGRSTRule', 'SpeechEngineConfidence', 'DISPID_SGRsCommit',
    'SAFTGSM610_44kHzMono', 'IStream', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SVSInputSentenceLength', 'SPEI_WORD_BOUNDARY',
    'SREPrivate', 'SECFDefault', 'eWORDTYPE_DELETED',
    'SREFalseRecognition', 'SRTAutopause', 'DISPID_SVEStreamEnd',
    'SP_VISEME_7', 'SP_VISEME_10', 'DISPID_SpeechGrammarRules',
    'DISPID_SGRSTPropertyId', 'SpeechVoicePriority', 'SpObjectToken',
    'SVEPrivate', 'SPEI_UNDEFINED', 'DISPID_SRCCmdMaxAlternates',
    'SPSEMANTICERRORINFO', 'tagSTATSTG', 'ISpRecoGrammar2',
    'DISPID_SPAStartElementInResult', 'SRADynamic',
    'tagSPPROPERTYINFO', 'DISPID_SpeechPhraseElements',
    'DISPID_SpeechVoice', 'SAFT24kHz8BitMono', 'SPSMF_UPS',
    'SPXMLRESULTOPTIONS', 'DISPID_SRRRecoContext', 'ISpeechVoice',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SCSBaseStream',
    'SRTEmulated', 'SpeechInterference', 'DISPID_SRRSaveToMemory',
    'SRTStandard', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SPWT_DISPLAY',
    'DISPID_SASetState', 'SVP_2', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SRCCreateResultFromMemory', 'SPXRO_Alternates_SML',
    'SPEI_RESERVED2', 'SpeechRecoProfileProperties',
    'DISPID_SRRSetTextFeedback', 'SBOPause', 'SVP_3',
    'DISPID_SRCResume', 'SVP_8', 'ISpRecognizer',
    'eLEXTYPE_RESERVED4', 'DISPID_SVSVisemeId', 'SpMMAudioIn',
    'SPSERIALIZEDPHRASE', 'SPEI_SR_BOOKMARK', 'SPGS_DISABLED',
    'DISPID_SPEActualConfidence', 'SRESoundStart', 'SRTReSent',
    'SRAORetainAudio', 'SAFT12kHz8BitStereo',
    'DISPID_SpeechRecoResult', 'SPVPRIORITY', 'DISPID_SPRText',
    'SPEI_REQUEST_UI', 'SPSHT_EMAIL', 'DISPID_SRGIsPronounceable',
    'SPRST_INACTIVE_WITH_PURGE', 'SSSPTRelativeToStart', 'SGSEnabled',
    'DISPID_SpeechLexiconWord', 'eLEXTYPE_RESERVED10',
    'DISPID_SVAudioOutputStream', 'DISPID_SREmulateRecognition',
    'DISPID_SVGetAudioInputs',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SPCATEGORYTYPE',
    'SpeechMicTraining', 'DISPID_SPIStartTime',
    'SAFTCCITT_uLaw_8kHzMono', 'SpInprocRecognizer',
    'ISpeechGrammarRuleState', 'ISpeechPhraseElement',
    'DISPID_SAFType', 'SPBO_TIME_UNITS', 'DISPID_SVEPhoneme',
    'SVP_19', 'SPEI_VISEME', 'DISPID_SVSkip', 'SPEI_RESERVED3',
    'DISPID_SPPBRestorePhraseFromMemory', 'IInternetSecurityManager',
    'DISPID_SOTMatchesAttributes', 'DISPID_SPCPhoneToId',
    'SPAS_PAUSE', 'DISPID_SGRName', 'SPINTERFERENCE_NOSIGNAL',
    'DISPID_SpeechPhraseReplacement', 'SAFT12kHz8BitMono',
    'SPCT_COMMAND', 'SpeechAllElements', 'SPPS_Verb',
    'ISpeechLexiconPronunciations', 'ISpShortcut', 'SDTDisplayText'
]

_check_version('1.4.1', 1733150633.769484)
